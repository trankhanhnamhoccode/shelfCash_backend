...
from app.schemas.operational import (
    CalendarFeatureResponse,
    ImportSummaryResponse,
    InventoryLotResponse,
    InventoryMovementResponse,
    Page,
    PurchaseHistoryRecordResponse,
    RecipeVersionSummaryResponse,
    SalesHistoryRecordResponse,
    UsageHistoryRecordResponse,
)
...
@router.get("/stores/{store_id}/imports", response_model=Page[ImportSummaryResponse])
...
@router.get(
    "/stores/{store_id}/products/{product_id}/recipe-versions",
    response_model=Page[RecipeVersionSummaryResponse],
)
...
@router.get("/stores/{store_id}/sales-history", response_model=Page[SalesHistoryRecordResponse])
...
@router.get("/stores/{store_id}/usage-history", response_model=Page[UsageHistoryRecordResponse])
...
@router.get("/stores/{store_id}/purchase-history", response_model=Page[PurchaseHistoryRecordResponse])
...
@router.get("/stores/{store_id}/inventory", response_model=Page[InventoryLotResponse])
...
@router.get("/stores/{store_id}/inventory-movements", response_model=Page[InventoryMovementResponse])
...
@router.get("/stores/{store_id}/calendar-features", response_model=Page[CalendarFeatureResponse])
