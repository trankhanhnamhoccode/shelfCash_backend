...
from app.schemas.decision import DecisionPackage, DecisionRunRequest, ExplanationRequest, WhatIfRequest
...
@router.post("/stores/{store_id}/forecast-runs/{forecast_run_id}/ingredient-demand",response_model=IngredientDemandRunResponse)
...
@router.get("/stores/{store_id}/forecast-runs/{forecast_run_id}/ingredient-demand",response_model=IngredientDemandRunResponse)
...
@router.post("/stores/{store_id}/forecast-runs/{forecast_run_id}/procurement-plans",response_model=ProcurementPlanRunResponse)
...
@router.get("/stores/{store_id}/forecast-runs/{forecast_run_id}/procurement-plans",response_model=ProcurementPlanRunResponse)
...
@router.post("/stores/{store_id}/decision-runs",response_model=DecisionPackage)
...
@router.get("/decision-runs/{decision_run_id}",response_model=DecisionPackage)
