        ...
        with self.factory() as s:
            ...
            for x in rows:
                ...
                items.append({"lot_id":x.lot_id,"ingredient_id":x.ingredient_id,"ingredient":ing.ingredient if ing else None,
                    ...
                    "expiring_quantity":expiring,"expired_quantity":expired,"unit":x.unit,"unit_cost":x.unit_cost,"batch_code":x.batch_code,"received_date":x.received_date,"received_date_status":x.received_date_status,
