...
ALIASES = {
    ...
    "ingredient_name": ["nguyen lieu", "ten hang", "ten nl", "ap dung cho nl", "mat hang ton", "thanh phan", "material", "ingredient", "ingredient name"],
    ...
    "quantity_used": ["luong dung", "luong thuc dung", "so luong su dung", "quantity used"],
    "waste_quantity": ["hao hut", "waste quantity"],
    "ingredient_quantity": ["dinh luong", "luong 1 sp", "ingredient quantity"],
    "ingredient_unit": ["don vi nguyen lieu", "ingredient unit"],
    "yield_quantity": ["san luong", "yield", "yield quantity"],
    "yield_unit": ["don vi sp", "yield unit"],
    "recipe_version": ["ver", "phien ban cong thuc", "recipe version", "version cong thuc"],
    "recipe_version": ["phien ban cong thuc", "recipe version", "version cong thuc"],
    "purchase_date": ["ngay nhap", "nct", "purchase date"],
    "quantity_received": ["so luong nhap", "sl nhap", "sln", "quantity received"],
    ...
    "is_weekend": ["cuoi tuan", "weekend", "is weekend"],
    "is_holiday": ["ngay le", "holiday", "is holiday"],
    "is_store_closed": ["store closed", "dong cua"],
    "is_promotion": ["promo", "khuyen mai", "is promotion"],
...
SHEET_KEYWORDS = {
    ...
    "inventory": ["kiem ke", "kiemke", "ton kho", "inventory", "stock"],
