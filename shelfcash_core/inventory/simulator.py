...
from shelfcash_core.inventory.accounting import validate_accounting_ledger
from shelfcash_core.inventory.adapters import (
...
from shelfcash_core.inventory.fefo import consume_fefo, fefo_sort_key, is_expired
from shelfcash_core.inventory.metrics import (
...
def simulate_inventory_scenarios(
    initial_inventory: Sequence[InventoryLot],
