...
from shelfcash_core.bom.recipe_resolver import RecipeResolver
from shelfcash_core.bom.units import (
    UnitConverter,
    convert_product_quantity,
    normalize_unit,
)
from shelfcash_core.contracts import ForecastPackage, ForecastPrediction
from shelfcash_core.exceptions import UnitConversionError


def ingredient_adjustment_factor(
...
def _convert_forecast_to_yield_unit(
